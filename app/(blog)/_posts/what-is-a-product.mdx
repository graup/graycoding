...
Great products have two major aspects: they provide a _solution_, and they provide an _experience_.
...
If you focus on only solving problems, you might end up with a product that works technically but doesn’t resonate with users.
